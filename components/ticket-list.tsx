...
import { isTrader } from "@/lib/utils"
    ...
    async function loadTickets() {
      try {
        ...
        if (user && user.steamid) {
          ...
          const userIsTrader = isTrader()
          // If user is a trader, they can see all tickets
          const userTickets = await getTickets(user.steamid, userIsTrader)
